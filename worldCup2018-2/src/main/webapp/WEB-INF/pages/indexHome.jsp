  ...
  <body>
    ...
    <div class="kode-wrapper">
			...
			<div class="container">
				...
				<div class="kode-navigation pull-left">
					<ul>
						...
						<li><a href="<%=request.getContextPath()%>/winabet/game">Résultat par match</a></li>
      ...
      <div class="kode-content">
      	<iframe width="560" height="315" src="https://www.youtube.com/embed/bngMoksUJ5o?rel=0&amp;showinfo=0" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
      </div>
